...
class ModulesManager {
    ...
    async _loadModule(module) {
        await this._injector.get(app_1.App).events.beforeModuleInit.fireEvent({ module: module.module });
        await module.initialize();
        await this._injector.get(app_1.App).events.moduleInit.fireEvent({ module: module.module });
    }

...
class ModulesManager {
    ...
    async loadDynamicModules() {
        ...
        await this._injector.get(app_1.App).events.beforeModulesLoad.fireEventAsync();
        ...
        await this._injector.get(app_1.App).events.afterModulesLoaded.fireEventAsync();
    }
    ...
    async _loadModule(module) {
        await this._injector.get(app_1.App).events.beforeModuleInitialize.fireEventAsync({ module: module.module });
        await module.initialize();
        await this._injector.get(app_1.App).events.afterModuleInitialize.fireEventAsync({ module: module.module });
    }

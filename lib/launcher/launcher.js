...
const beforeDecorator_1 = require("../decoretors/beforeDecorator");
...
class Launcher {
    ...
    _handlePipeLines() {
        for (let i = 0, len = (this.exported || []).length; i < len; i++) {
            ...
            beforeDecorator_1.handleBeforeDecorator(item.fn, this._app);
            beforeDecorator_1.handleAfterDecorator(item.fn, this._app);
